package GeekBrains.Архитектура.Seminar_4;
...
class TicketProvider{
    ...
    public Ticket buyTicket(int clientId, String cardNo){
        // ПРЕДУСЛОВИЕ
        if (clientId < 1 || cardNo == null) {
            throw new RuntimeException("Error! Check the data.");
        }
        ...
        if (paymentProvider.buy(orderId, cardNo, amount)) {
            ...
            Ticket ticket = new Ticket(clientId, new Date());
            ticket.getQrcode();
        ...
        // ПОСТУСЛОВИЕ
            ...
            throw new RuntimeException("ERROR! Payment failed.");
        }
    }
